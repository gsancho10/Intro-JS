...
let current = this.head // "eu current, parate y decime lo que tiene el head (primer nodo de la lista)"
...
var callback;
  ...
  if (typeof algo !== "function"){ // verificamos si el argumento que recibimos no es una funcion
