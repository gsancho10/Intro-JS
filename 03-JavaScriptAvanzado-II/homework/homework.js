...
function cacheFunction(cb) {
  ...
  que recibe por parámetro (cb); es decir, que "recuerde" el resultado de cada operación que hace, de manera que,
   al realizar una operación por segunda vez, se pueda obtener el resultado de esa "memoria" sin tener que efectuar otra 
 ...
 var cajita = {}
 return function pepe (argumento){
  if (cajita.hasOwnProperty(argumento)){
    return cajita[argumento]
  }
  let total = cb(argumento);
  cajita[argumento] = total
  return total
 }
}
